...
# First step is to save all the links to the fighters profiles that I want to get information from 
# w pierwszym kroku pobieram werktor linkow stron ktore chce skanowac
N = 64850 # linków do pobrania  
...
wektorLinkowU<- wektorLinkow%>%unique()  # usuwam duplikaty

# I am scraping the data form chosen spots on the nested websides - on the fighters profiles
# nastepnie pobieram dane dla wybranych miejsc na stronie zagnieżdżonej - profilu zawodnika
...
# the next step is download data as tables, convert them as dataframe and transpone to the form of row in order to easly append it with other upcoming observations. 
